...
public abstract class MicroService implements Runnable {
    ...
    /**
     * @param _name the micro-service name (used mainly for debugging purposes -
     *             does not have to be unique)
     */
    public MicroService(String _name) {
        name = _name;
        callbacksMap = new HashMap<Class<? extends Message>,Callback>();
    ...
    public final void run() {
        ...
        while (!terminated) {
            try {
                Message msg = mBus.awaitMessage(this);
                if( msg != null){
