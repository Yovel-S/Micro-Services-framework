...
public interface MessageBus {
    /**
     * @return true iff MicroService m is subscribed to Event of "type"
     */
     <T> boolean isSubscribedToEvent(Class<? extends Event<T>> type, MicroService m);

     /**
      * @return true iff MicroService m is subscribed to Broadcast of "type"
     */
     <T> boolean isSubscribedToBroadCast(Class<? extends Broadcast> type, MicroService m);

    /**
     * @return true iff Event e is completed
     */
     <T> boolean isComplete(Event<T> e);
    /**
     * @return true iff BroadCast b sent successfully
     */
     boolean isBroadcastSent(Broadcast b, MicroService m);
    /**
     * @return true iff Event e sent successfully
     */
    <T> boolean isEventSent(Event<T> e, MicroService m);

    /**
     * @return true iff MicroService m is registered
     */
    boolean isRegistered(MicroService m);
    /**
     * @return true iff b sent successfully
     */
    boolean isAwaitSucceded(MicroService m);
    /**
     ...
     * @pre isBroadcastSent(b)=false
     * @post isBroadcastSent(b)=true
     */
     ...
     * @pre isEventSent(e)=false
     * @post isEventSent(e)=true
     */
